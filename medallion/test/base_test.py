...
class TaxiiTest():
    ...
    def setUp(self, start_threads=True):
        ...
        # hack to avoid registering blueprints twice when testing
        if "collections" not in self.app.blueprints:
        ...
        APPLICATION_INSTANCE.medallion_backend = connect_to_backend(APPLICATION_INSTANCE, get_application_instance_config_values("backend"))
